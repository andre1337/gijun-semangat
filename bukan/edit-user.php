          ...
          <div class="card-body">
            <form action="../config/updateuser.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="col-md-1"></div> 
                ...
                <div class="col-md-6">
                  <input class="form-control" type="nik" name="nik" id="nik" value="<?php echo $data['nik']; ?>" maxlength="8">
                </div>
              </div>
              <div class="form-group input-group">
                <div class="col-md-1"></div>
              ...
              <div class="col-md-1"></div>
                ...
                <label class="col-md-1">:</label>
                <div class="col-md-6">          
                  <input type="text" name="password" class="form-control" id="password" value="<?php echo $data['password']; ?>" maxlength="8">
                </div>
              </div>
              <div class="form-group input-group">
              <div class="col-md-1"></div>
                ...
                <label class="col-md-1">:</label>
                <div class="col-md-6">
                  <input type="text" class="form-control" id="pwd" name="passwordkonfirm">
              </div>
              <div class="form-group input-group">
                <div class="col-md-6">
