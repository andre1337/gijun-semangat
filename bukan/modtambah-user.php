        ...
        <div class="modal-body">
          <form action="../config/tambahuser.php" method="POST" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <label class="col-md-1">:</label>
                <div class="col-md-6">
                  <input type="nik" name="nik" class="form-control" placeholder="Isi Nomer NIK" onkeypress="return hanyaAngka(event)"/ maxlength="6" required>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-md-1"></div>
                  ...
                  <label class="col-md-1">:</label>
                  <div class="col-md-6">
                    <input type="tlp" name="tlp" class="form-control" placeholder="Isi Nomer Telepon" onkeypress="return hanyaAngka(event)"/ maxlength="12" required>
                  </div>
              </div>
              <div class="form-group">
              <div class="col-md-1"></div>
